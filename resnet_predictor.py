...
#             #     if label[i]==1:
#             #         save_img.append(img[i])
#             # save_img=torch.stack(save_img,dim=0)
#             # save_image(save_img, 'checkpoints/%d.jpg' % j, normalize=True)
...
if __name__ == '__main__':
    ...
    attrs=['Male', 'Mouth_Slightly_Open', 'Mustache', 'Narrow_Eyes', 'No_Beard', 'Oval_Face', 'Pale_Skin', 'Pointy_Nose', 'Receding_Hairline', 'Rosy_Cheeks', 'Sideburns', 'Smiling', 'Straight_Hair', 'Wavy_Hair', 'Wearing_Earrings', 'Wearing_Hat', 'Wearing_Lipstick', 'Wearing_Necklace', 'Wearing_Necktie', 'Young']
    #attrs = ['Pale_Skin']
    attrs=['Bald']
